...
file_path = "saved_angle_checkpoint.pth"

device = torch.device("cuda" if torch.cuda.is_available() else "cpu")
checkpoint_angle = torch.load(file_path, map_location=device)
...
model_angle.load_state_dict(checkpoint_angle['model_state_dict'])
